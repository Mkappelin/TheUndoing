#include "MagicianPlayerController2.h"
...
void AMagicianPlayerController2::BeginPlay()
{
	Super::BeginPlay();
...
void AMagicianPlayerController2::SetupInputComponent()
{
	...
	InputComponent->BindAction("PaintButton", IE_Pressed, this, &AMagicianPlayerController2::PressedToPaint);
	InputComponent->BindAction("PaintButton", IE_Released, this, &AMagicianPlayerController2::ReleasedToPaint);
	InputComponent->BindKey(EKeys::T, IE_Pressed, this, &AMagicianPlayerController2::TogglePaintMode);
}


void AMagicianPlayerController2::Tick(float DeltaTime)
{
...
void AMagicianPlayerController2::PressedToPaint()
{
...
void AMagicianPlayerController2::TogglePaintMode()
{
...
void AMagicianPlayerController2::ReleasedToPaint()
{
	if (CurrentAction == Action::Paint)
...
void AMagicianPlayerController2::Spell()
{
...
void AMagicianPlayerController2::LoadTemplates()
{
	if (GEngine) {
		GEngine->AddOnScreenDebugMessage(
			-1,                     // Key (-1 means "new message")
...
void AMagicianPlayerController2::TrainMode(const bool Is)
{
	IsTraining = Is;
...
void AMagicianPlayerController2::AddTemplateToDataTable(const FString Name)
{
...
void AMagicianPlayerController2::ShowTrainWidget()
{
	if (TrainWidget != nullptr)
	{
...
void AMagicianPlayerController2::HideTrainWidget()
{
	if (TrainWidget != nullptr)
	{
		PaintWidget->RemoveAllPoints();
